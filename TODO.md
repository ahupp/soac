 ...
 * Make entry/deopt `MakeFunctionWithClosure` replay use explicit shared-state/static metadata instead of resolving through `_soac_ext`'s process `CompileSession`.
