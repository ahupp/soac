...
pub(super) enum ParamAbi {
    PyObject { ownership: ArgOwnership },
    I64,
    I32,
}
...
pub(super) enum ResultAbi {
    PyObject { ownership: ValueOwnership },
    I64,
    I32,
    NoValue,
}
...
mod tests {
    ...
    fn chr_descriptor_accepts_i64_and_returns_owned_pyobject() {
        ...
        assert_eq!(desc.abi.hidden_args, &[HiddenArgAbi::ThreadState]);
        assert_eq!(desc.abi.params, &[ParamAbi::I64]);
        assert_eq!(
            desc.abi.result,
            ResultAbi::PyObject {
                ownership: ValueOwnership::Owned
    ...
    fn builtin_name_lookup_maps_ord_and_chr_to_runtime_primitives() {
        ...
        assert_eq!(runtime_primitive_for_builtin_name("len"), None);
    }
}
