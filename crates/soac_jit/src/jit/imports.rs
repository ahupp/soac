...
use super::symbols::{
    ...
    SOAC_RUNTIME_COUNT_AFFINE_DISTINCT_PERMUTATIONS_I64_SYMBOL, SOAC_RUNTIME_DECREF_APPLIED_SYMBOL,
    SOAC_RUNTIME_DECREF_DEALLOC_PRESERVING_ERROR_SYMBOL, SOAC_RUNTIME_DECREF_SYMBOL,
...
pub(super) static SOAC_RUNTIME_COUNT_AFFINE_DISTINCT_PERMUTATIONS_I64_IMPORT: ImportSpec =
    ImportSpec::local(
        SOAC_RUNTIME_COUNT_AFFINE_DISTINCT_PERMUTATIONS_I64_SYMBOL,
        &[SigType::I64],
        &[SigType::I64],
    );
