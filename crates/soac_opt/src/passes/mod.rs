...
pub use crate::typed::{
    ...
    TypedFullyVirtualObjectLoweringStats, TypedGeneratorStateLoweringPlan,
    ...
    TypedInlineRewriteStats, TypedVirtualBodyInstr, TypedVirtualBodyMaterializationStats,
    TypedVirtualBoundaryKind, TypedVirtualBoundaryLocation, TypedVirtualConstructorStats,
    TypedVirtualFieldEdge, TypedVirtualFieldRef, TypedVirtualFieldStateAnalysis,
    TypedVirtualMaterializationBoundary, TypedVirtualMaterializationRecipe, TypedVirtualObjectId,
    TypedVirtualObjectLoweringStats, TypedVirtualObjectPlan,
    TypedVirtualReturnMaterializationStats, TypedVirtualState,
    ...
    lower_typed_function_if_tests_to_truthy, lower_typed_generator_state_to_locals_with_plan,
