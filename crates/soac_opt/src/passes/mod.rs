...
pub use crate::typed::{
    ...
    lower_typed_generator_resume_preserved_state_to_locals,
    ...
    lower_typed_if_tests_to_truthy, lower_typed_virtual_fields_to_locals_with_plan,
    ...
    sync_typed_module_value_facts, trusted_fully_virtual_constructor_owner,
    trusted_function_field_target_for_origin, trusted_function_id_for_expr,
    trusted_generator_instance_owner, trusted_generator_origin_for_name,
    ...
    trusted_owner_block_predecessor_edges, trusted_owner_state_for_name,
    trusted_runtime_name_for_expr, try_lower_typed_instr_to_codegen_legacy,
...
pub use local_env_plan::{
    ...
    plan_typed_function_locals, plan_typed_local_env_module,
...
pub use ownership_effects::{
    ...
    TypedModulePreciseImmortalLocalEntryStates, TypedPreciseImmortalLocalEntryStates,
    ...
    compute_typed_module_precise_immortal_local_entry_states, plan_ownership_effects,
    plan_typed_ownership_effects, plan_typed_ownership_effects_with_precise_immortal_states,
    refcount_release_location_branch_name, refcount_release_reason_label,
    refcount_stack_slot_location_branch_name, validate_ownership_effects,
