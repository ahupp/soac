    ...
    E: RuffToBlockPyExpr + crate::block_py::ImplicitNoneExpr,
{
    match expr {
        ...
        InstrRuff::ExprNamed(named_expr) => lower_named_expr_into(lowerer, named_expr, out, loop_ctx),
        expr @ (
            InstrRuff::StmtFunctionDef(_)
        ...
        other => other.try_map_same_children(&mut |child| lower_expr_ast_recursive(lowerer, child, out, loop_ctx)),
    }
}
