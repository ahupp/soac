...
trait InstrRuffAstExt: Sized {
    ...
    fn from_ast_expr(value: ast::Expr) -> Self;
    fn from_ast_stmt(value: ast::Stmt) -> Self;
    fn into_ast_stmt(self) -> ast::Stmt;
}

impl InstrRuffAstExt for InstrRuff {
    fn wrap_ast_expr<O>(meta: Meta, op: O) -> Self
    where
        O: WithMeta + Into<Self>,
    {
...
pub(crate) fn from_ast_expr(value: ast::Expr) -> InstrRuff {
    <InstrRuff as InstrRuffAstExt>::from_ast_expr(value)
}

pub(crate) fn from_ast_stmt(value: ast::Stmt) -> InstrRuff {
    <InstrRuff as InstrRuffAstExt>::from_ast_stmt(value)
}

pub(crate) fn into_ast_expr(value: InstrRuff) -> ast::Expr {
    <InstrRuff as InstrRuffAstExt>::into_ast_expr(value)
}

pub(crate) fn into_ast_stmt(value: InstrRuff) -> ast::Stmt {
    <InstrRuff as InstrRuffAstExt>::into_ast_stmt(value)
}
