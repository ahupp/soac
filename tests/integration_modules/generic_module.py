...
def validate_module(module):
    ...
    def _assert_generic_module_invariants(module: ModuleType) -> None:
        soac_typing = sys.modules["typing"]
        if __dp_integration_soac__:
            assert type(module) is ModuleType, "SOAC-loaded modules should use a real module object"
        ...
        assert module.Box.__orig_bases__ == (soac_typing.Generic[module.T],)
