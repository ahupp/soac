...
def factory():
    ...
    return local, Local
# ok
# tests/test_strict_function_boundaries.py::test_cpython_lambda_source_identities_match_native_comprehension_scopes
import sys
...
def validate(module):
    ...
    def observations(mod, strict):
        ...
        expected = 'original_code' if strict else None
