...
def source_local(target, value):
    target.value = value
# ok
# tests/test_strict_function_boundaries.py::test_attribute_assignment_source_local_preserves_identity_and_cleanup
import sys
...
assert _soac_ext.strict_function_entry_kind(actual.source_local) == ('entry_interpreter' if __dp_integration_entry__ else 'checked_native')
