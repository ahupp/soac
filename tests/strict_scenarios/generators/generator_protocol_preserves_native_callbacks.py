...
def make_injection(mode, delegate, observe):
    ...
    return injection_plain(observe)
# ok
# tests/test_strict_generator_protocols.py::test_generator_protocol_preserves_native_callbacks
import sys
...
expected = exercise(ordinary, 'raw_throw_yields', None, 'stock')
exercise(module, 'raw_throw_yields', expected, __dp_integration_mode__)
...
expected = exercise(ordinary, 'raw_throw_completes_delegate', None, 'stock')
exercise(module, 'raw_throw_completes_delegate', expected, __dp_integration_mode__)
...
expected = exercise(ordinary, 'throw_lookup_error', None, 'stock')
exercise(module, 'throw_lookup_error', expected, __dp_integration_mode__)
...
expected = exercise(ordinary, 'missing_throw_normalizes_after_lookup', None, 'stock')
exercise(module, 'missing_throw_normalizes_after_lookup', expected, __dp_integration_mode__)
...
expected = exercise(ordinary, 'delegate_receives_invalid_exception_type', None, 'stock')
exercise(module, 'delegate_receives_invalid_exception_type', expected, __dp_integration_mode__)
...
expected = exercise(ordinary, 'close_delegate', None, 'stock')
exercise(module, 'close_delegate', expected, __dp_integration_mode__)
...
expected = exercise(ordinary, 'close_return_value', None, 'stock')
exercise(module, 'close_return_value', expected, __dp_integration_mode__)
...
expected = exercise(ordinary, 'invalid_throw_keeps_suspended', None, 'stock')
exercise(module, 'invalid_throw_keeps_suspended', expected, __dp_integration_mode__)
...
expected = exercise(ordinary, 'created_throw', None, 'stock')
exercise(module, 'created_throw', expected, __dp_integration_mode__)
...
expected = exercise(ordinary, 'created_invalid_throw', None, 'stock')
exercise(module, 'created_invalid_throw', expected, __dp_integration_mode__)
...
expected = exercise(ordinary, 'reentrant_send', None, 'stock')
exercise(module, 'reentrant_send', expected, __dp_integration_mode__)

_assert_source_function_witnesses()
# ok
# tests/test_strict_generator_protocols.py::test_generator_injected_exception_uses_own_handled_item
import sys
from soac import _soac_ext, import_hook
def _assert_source_function_witnesses():
    from tests._strict_integration import (
    ...
    for _scenario_name in ('make_injection',):
        _scenario_function = _plain_function_witness(module, _scenario_name)
        if __dp_integration_mode__ == "cpython":
            _assert_cpython_function_witness(
                _scenario_function, _soac_ext.strict_module_diagnostics(module),
...
expected = exercise(ordinary, 'plain_throw', None, 'stock')
exercise(module, 'plain_throw', expected, __dp_integration_mode__)
...
expected = exercise(ordinary, 'handled_throw', None, 'stock')
exercise(module, 'handled_throw', expected, __dp_integration_mode__)
...
expected = exercise(ordinary, 'delegate_error', None, 'stock')
exercise(module, 'delegate_error', expected, __dp_integration_mode__)
