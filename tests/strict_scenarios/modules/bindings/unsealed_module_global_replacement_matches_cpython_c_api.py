# modes:soac,entry
# test_strict_module_preconditions.py::test_reviewed_preconditions_use_authenticated_entries[unsealed_module_global_replacement_matches_cpython_c_api]
# module:unsealed_module_global_replacement_matches_cpython_c_api
...
def call(value):
    return target(value)
# module:ordinary_unsealed_module_global_replacement_matches_cpython_c_api
def target(value):
    return value + 1
...
def call(value):
    return target(value)
# ok
# unsealed_module_global_replacement_matches_cpython_c_api
import sys
import pytest
...
def validate_module(module):
    stock = importlib.import_module('ordinary_unsealed_module_global_replacement_matches_cpython_c_api')
