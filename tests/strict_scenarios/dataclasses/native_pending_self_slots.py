...
# ok
# test_cpython_dataclass_pending_calls_are_ordinary_and_selected_self_fields_are_checked [Node | None]
import sys
...
_scenario_check_source_functions()
# ok
# test_cpython_dataclass_slots_original_is_not_kept_by_completion_metadata [default]
import sys
from soac import _soac_ext
import importlib
from tests._strict_integration import _plain_function_witness, _assert_cpython_function_witness
